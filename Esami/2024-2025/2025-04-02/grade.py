...
def test_func1_2():
    ...
    string_list1 = ['coke', 'fanta', 'sprite', 'lambdala', 'lemonsoda', 'oransoda']
    string_list2 = ['coke', 'fanta', 'oransoda', 'pepsi']
    expected = ['pepsi', 'sprite', 'lambdala', 'lemonsoda']
    return do_func1_tests(string_list1, string_list2, expected)

def test_func1_3():
    '''
    string_list1 = ['Paperino','Topolino','Minnie', 'Gastone']
    string_list2 = ['Paperone','Minnie','Pluto', 'Gastone']
    '''
    string_list1 = ['Paperino','Topolino','Minnie', 'Gastone']
    string_list2 = ['Paperone','Minnie','Pluto', 'Gastone']
    expected = ['Pluto', 'Topolino', 'Paperone', 'Paperino']
    return do_func1_tests(string_list1, string_list2, expected)
...
def test_ex1_1():
    ...
    directory = 'ex1/A'
    ext = '.py'
    expected = {'ex1/A/C': 237, 'ex1/A': 145}
...
def test_ex1_2():
    ...
    directory = 'ex1/B'
    ext = '.txt'
    expected = {'ex1/B/C': 329, 'ex1/B/D': 216, 'ex1/B/B': 25, 'ex1/B': 148}
    return do_test_ex1(directory, ext, expected)
...
def test_ex1_3():
    ...
    directory = 'ex1'
    ext = '.txt'
    expected = {'ex1/A/C': 237, 'ex1/A/B': 25, 'ex1/A': 145, 'ex1/B/C': 329, 'ex1/B/D': 216, 'ex1/B/B': 25, 'ex1/B': 148, 'ex1': 290}
    return do_test_ex1(directory, ext, expected)
...
if __name__ == '__main__':
    ...
    if 'nome' in dir(program):
        print(f">>>>>>>>>>> {program.nome} {program.cognome} {program.matricola} <<<<<<<<<<<<")
    else:
        print(f">>>>>>>>>>> {program.name} {program.surname} {program.student_id} <<<<<<<<<<<<")
